...
// Clear the loot table for woodlands mansion chest
val woodlandsMansion = LootTweaker.getTable("minecraft:chests/woodland_mansion");
woodlandsMansion.clear();

// Add the first loot pool with roll range 1-3
val pool1 = woodlandsMansion.addPool("pool1", 1.0, 3.0, 0.0, 0.0);

pool1.addItemEntry(<minecraft:lead>, 20, 0, "lead_entry");
...
pool1.addItemEntry(<minecraft:chainmail_chestplate>, 10, 0, "chainmail_chestplate_entry");
...
val pool2 = woodlandsMansion.addPool("pool2", 1.0, 4.0, 0.0, 0.0);

pool2.addItemEntry(<minecraft:iron_ingot>, 10, 0, 
[
    {
...
val pool3 = woodlandsMansion.addPool("pool3", 3.0, 3.0, 0.0, 0.0);
